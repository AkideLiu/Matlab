...
% Description : This script that uses nested loops to create a 100 by 100 element 2D array representing an image that shades from black at the left of the image to white at the right of the image.
