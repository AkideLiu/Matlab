    ...
    for row = 1:rows * 2
        ...
        for col = 1:cols
            ...
            if mod(row, 2) == 1
                ...
                % element >0        print how many mines around this location
                % element = -1      print empty block
                % element = -2      print mine
                % element <= 0      not select by user or not progress by boomEvenProgresser
