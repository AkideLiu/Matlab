...
% Description : This script defines a vector A  and create a new vector B containing the elements of A shifted one index to the right. The first element of B should be the last element of A. Thus A and B will be of the same length.
...
% set the completion number (last element in vector A)
shiftTo = A(length(A));
